...
class Media {
  constructor({
    ...
    this.createShader();
    this.createMesh();
    // Title labels removed as requested
    this.onResize();
  }
  createShader() {
...
class App {
  ...
  createMedias(items, bend = 1, textColor, borderRadius, font) {
    // UPDATED: Removing ?grayscale from default images as requested.
    const defaultItems = [
      { image: '/DSC00896 (1).JPG', text: 'DSC00896 (1)' },
      { image: '/DSC00909.JPG', text: 'DSC00909' },
      { image: '/DSC00912.JPG', text: 'DSC00912' },
      { image: '/DSC00915.JPG', text: 'DSC00915' },
      { image: '/DSC00931.JPG', text: 'DSC00931' },
      { image: '/DSC00949 (1).JPG', text: 'DSC00949 (1)' },
      { image: '/DSC00949.JPG', text: 'DSC00949' },
      { image: '/DSC00979.JPG', text: 'DSC00979' },
      { image: '/DSC00984.JPG', text: 'DSC00984' },
      { image: '/DSC01006.JPG', text: 'DSC01006' },
      { image: '/DSC01035.JPG', text: 'DSC01035' },
      { image: '/DSC01224.JPG', text: 'DSC01224' },
      { image: '/DSC01231.JPG', text: 'DSC01231' },
      { image: '/retro-tv.jpg', text: 'Retro TV' },
      { image: '/geeksforgeeks.png', text: 'GeeksforGeeks' },
      { image: '/gemini.png', text: 'Gemini' },
      { image: '/hack2skills.png', text: 'Hack2Skills' },
      { image: '/hackerrank.png', text: 'HackerRank' },
      { image: '/stpeters.png', text: 'St Peters' },
      { image: '/icons.svg', text: 'Icons' },
      { image: '/favicon.svg', text: 'Favicon' }
    ];
    // NOTE TO USER: When passing your own items as a prop, provide URLs to colored images.
