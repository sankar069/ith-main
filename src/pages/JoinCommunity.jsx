...
const DEFAULT_DISCORD_LINK = 'https://discord.gg/CMegRgSgM'

export default function JoinCommunity() {
  const [discordLink, setDiscordLink] = useState(DEFAULT_DISCORD_LINK)

  useEffect(() => {
    fetch('/api/site-settings')
      .then((r) => r.json())
      .then((data) => {
        if (data.settings?.discord_link) setDiscordLink(data.settings.discord_link)
      })
      .catch(() => {})
  }, [])
